...
import s1 from '../../assets/bodyten/m1.jpg'
import s2 from '../../assets/bodyten/m2.jpg'
import s3 from '../../assets/bodyten/m3.jpg'
import s4 from '../../assets/bodyten/m4.jpg'
import s5 from '../../assets/bodyten/m5.jpg'
import s6 from '../../assets/bodyten/m6.jpg'
...
const BodyTenThree=()=>{
    ...
    return(
        <Stack  pb={1} sx={{ backgroundColor:'white',boxShadow:5,borderRadius:2}}>
             ...
             <Stack direction='row' mb={1} pl={3} pr={3} justifyContent='space-between'  alignItems='center'sx={{ height:50, backgroundColor:'#ff6900' }}>
                
                
                <h3 >Men's Clothing | Official Store</h3>
                <Link style={{ textDecoration:'none',position:'relative',  color:'black' }}> SEE ALL <ArrowForwardIosIcon sx={{fontSize:16,top:5,position:'relative',top:2}}/> </Link>
