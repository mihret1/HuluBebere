...
import s1 from '../../assets/bodysix/j1.jpg'
import s2 from '../../assets/bodysix/j2.jpg'
import s3 from '../../assets/bodysix/j3.jpg'
import s4 from '../../assets/bodysix/j4.jpg'
import s5 from '../../assets/bodysix/j5.jpg'
import s6 from '../../assets/bodysix/j6.jpg'
    ...
    return(
        <Stack  pb={3} sx={{ backgroundColor:'white'}}>
             ...
             <Stack direction='row' mb={1} pl={3} pr={3} justifyContent='space-between'  alignItems='center'sx={{ height:50, backgroundColor:'#86442d' }}>
                ...
                <h3 style={{ color:'white' }}>Women's Jewelry</h3>
