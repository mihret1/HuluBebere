...
import s1 from '../../assets/bodyeight/b1.jpg'
import s2 from '../../assets/bodyeight/b2.jpg'
import s3 from '../../assets/bodyeight/b3.jpg'
import s4 from '../../assets/bodyeight/b4.jpg'
import s5 from '../../assets/bodyeight/b5.jpg'
import s6 from '../../assets/bodyeight/b6.jpg'
    ...
    return(
        <Stack  pb={1} sx={{ backgroundColor:'white',boxShadow:5,borderRadius:2}}>
             ...
             <Stack direction='row' mb={1} pl={3} pr={3} justifyContent='space-between'  alignItems='center'sx={{ height:50, backgroundColor:'#86442d' }}>
                ...
                <h3 style={{ color:'white' }}>Beddings | Up to 50% Off</h3>
